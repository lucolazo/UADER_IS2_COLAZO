...
class Configuracion:
    ...
    """
    # Valores privados de clase
    _instancia = None
    _lock = Lock()  # para hacerlo thread-safe. (Cuando se está ejecutando, nadie mas puede ejecutar este singleton)
...
def main():
    ...
    # Modificación sólo a config2, pero afecta a config1
