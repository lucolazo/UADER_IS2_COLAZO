...
print(f"El valor del objeto es {log1}. El nombre es {log1.nombre} y el CUIT es {log1.CUIT}")
print(f"El valor del objeto es {log2}. El nombre es {log2.nombre} y el CUIT es {log2.CUIT}")
